 ...
 * @author Lenovo
 */
@WebServlet(name = "ShowTwoController", urlPatterns = {"/ShowTwoController"})
public class ShowTwoController extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(SearchAccountController.class);

    private static final String ERROR = "ShowTwo.jsp";
    private static final String SUCCESS = "ShowTwo.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            listTwo = dao.getTopTwo();
            request.setAttribute("LIST_TWO", listTwo);
            url = SUCCESS;
        } catch (Exception e) {
