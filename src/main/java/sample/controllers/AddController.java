...
public class AddController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            String phoneID = request.getParameter("phone-id");
            int quantity = Integer.parseInt(request.getParameter("quantity"));
            PhoneDAO dao = new PhoneDAO();
            PhoneDTO addedPhone = dao.getPhone(phoneID);
            addedPhone.setQuantity(quantity);
            ...
            request.setAttribute("MESSAGE", addedPhone.getPhoneName() + " added sucessfully!");
            url = SUCCESS;
        } catch (Exception e) {
