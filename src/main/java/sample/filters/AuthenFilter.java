...
public class AuthenFilter implements Filter {
    ...
    //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
    ...
    public AuthenFilter() {
        ...
        USER_RESOURCE.add("userProfile.jsp");
        USER_RESOURCE.add("ChangeAvatarController");
        ...
        ADMIN_RESOURCE.add("userProfile.jsp");
        ADMIN_RESOURCE.add("ChangeAvatarController");
        ...
        NON_AUTHEN_RESOURCE.add(".avatar");
        NON_AUTHEN_RESOURCE.add("login.js");
        NON_AUTHEN_RESOURCE.add("signup.js");
        NON_AUTHEN_RESOURCE.add("shopping.js");
        NON_AUTHEN_RESOURCE.add(".json");
        NON_AUTHEN_RESOURCE.add("shopping.jsp");
        NON_AUTHEN_RESOURCE.add("FindAccount.jsp");
        NON_AUTHEN_RESOURCE.add("index.jsp");
        NON_AUTHEN_RESOURCE.add("ConfirmCode.jsp");
        NON_AUTHEN_RESOURCE.add("cart.jsp");
        NON_AUTHEN_RESOURCE.add("registeConfirmPage.jsp");
        NON_AUTHEN_RESOURCE.add("ErrorController");
        NON_AUTHEN_RESOURCE.add("TestError");
        NON_AUTHEN_RESOURCE.add("");
    }
